...
static const int64_t MAX_MONEY = 4450000000 * COIN; // 4.45 Billion
...
static const int64_t COIN_YEAR_REWARD1 = 100 * CENT; // ~10% Annualy (25 Million CAKES) 6-months
static const int64_t COIN_YEAR_REWARD2 = 250 * CENT; // ~25% Annualy (62.5 Million CAKES) 6-months
static const int64_t COIN_YEAR_REWARD3 = 2500 * CENT; // ~250% Annualy (2.5 Billion CAKES) 2-years [3 Billion CAKES so far]
static const int64_t COIN_YEAR_REWARD4 = 50 * CENT; // ~5% Annualy (900 Million CAKES) 6-years [3.9 Billion CAKES so far]
static const int64_t COIN_YEAR_REWARD5 = 10 * CENT; // ~1% Annualy (Forever)
