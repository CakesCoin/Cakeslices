...
namespace json_spirit
{
    ...
    class Generator
    {
        ...
        typedef typename String_type::value_type Char_type;
        typedef typename Object_type::value_type Obj_mCakeslice_type;
    ...
    private:
        ...
        void output( const Obj_mCakeslice_type& mCakeslice )
        {
            output( Config_type::get_name( mCakeslice ) ); space(); 
            os_ << ':'; space(); 
            output( Config_type::get_value( mCakeslice ) );
        }
